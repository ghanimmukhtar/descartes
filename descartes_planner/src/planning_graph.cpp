                                            ...
                                            std::vector<std::vector<JointTrajectoryPt>>& poses)
{
  ...
  for (std::size_t i = 0; i < points.size(); ++i)
  {
    ...
    /*std::cout << "size of joint poses is: " << joint_poses.size() << std::endl;
    for(int k = 0; k < joint_poses.size(); k++)
        for(int jj = 0; jj < joint_poses[k].size(); jj++)
            std::cout << "element no: " << jj << " of joint pose no: " << k << " is: " << joint_poses[k][jj] << std::endl;*/
